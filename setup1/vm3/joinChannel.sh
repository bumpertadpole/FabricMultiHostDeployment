...
fetchChannelBlock() {
    ...
    peer channel fetch 0 ./channel-artifacts/$CHANNEL_NAME.block -o 52.14.146.132:7050 \
...
updateAnchorPeers() {
    ...
    # Replace localhost with your orderer's vm IP address
    peer channel update -o 52.14.146.132:7050 --ordererTLSHostnameOverride orderer.example.com \
